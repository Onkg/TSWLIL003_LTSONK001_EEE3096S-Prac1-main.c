...
void TIM16_IRQHandler(void)
{
	...
	// print something
//while (LL_GPIO_IsInputPinSet(Button3_GPIO_Port, Button3_Pin)// while the button is a logic high meaing it has not
		// been pressed keep going through the buttons upto the last one and back but once pressed
		// go out of loop and display pattern 1 only
